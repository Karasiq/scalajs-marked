package com.karasiq.highlightjs
...
trait HighlightJS extends js.Object {
  /**
    ...
    */
  def highlight(name: String, value: String, ignoreIllegals: Boolean = ???, continuation: js.Object = ???): HighlightJSResult = js.native
  ...
  /**
    ...
    */
  def highlightAuto(value: String, languageSubset: js.Array[String] = ???): HighlightJSResult = js.native
  ...
  /**
    ...
    */
  def highlightBlock(e: Element): Unit = js.native
